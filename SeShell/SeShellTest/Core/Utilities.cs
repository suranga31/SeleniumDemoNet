...
namespace SeShell.Test.Core
{
    public class Utilities
    {
        ...
        /// <summary>
        /// Gets the partial URL based on list item.
        /// </summary>
        /// <param name="listItem">The list item.</param>
        /// <param name="subGroups">The sub groups.</param>
        /// <returns>
        /// The partial url string of the required page
        /// </returns>
        ...
        public static void WriteToFile(ITestResults foo, string fileName)
        {
            ...
            using (var writer = new StreamWriter(string.Format("{0}{1}-{2}.xml", Configuration.NUnitModifiedTestResultLocation, fileName, DateTime.Now.Ticks)))
            {
